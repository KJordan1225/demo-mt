...
return [
    ...
    'bootstrappers' => [
        ...
        Stancl\Tenancy\Bootstrappers\SessionTenancyBootstrapper::class, // <-- important for auth cookies

        // Stancl\Tenancy\Bootstrappers\RedisTenancyBootstrapper::class, // Note: phpredis is needed
    ],

    'tenant_middleware' => [
        \Stancl\Tenancy\Middleware\InitializeTenancyByPath::class, // <-- use path
        \Stancl\Tenancy\Middleware\PreventAccessFromCentralDomains::class,
    ],

    'initialize_tenancy_by_path_params' => ['tenant'],
